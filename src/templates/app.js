...
(function () {
  ...
  function drawRouteOnMap(routeNum) {
    ...
    const KNOWN_STOPS_GEO = {
      "Школа №13": [58.265413, 57.824473],
      "Юбилейный": [58.268588, 57.824517],
      "ул.Юности": [58.272237, 57.816597],
      "Юность": [58.272237, 57.816597],
      "Ветеран": [58.2769898, 57.8143397],
      "ул.Мира": [58.2715, 57.8220],
      "ул.Чкалова": [58.284481, 57.815785],
      "пл.ЧМЗ": [58.295737, 57.814447],
      "ДКЖ": [58.295558, 57.82934],
      ...
      "пл.Металлургов": [58.2754717, 57.8315679],
      "Металлургов": [58.2754717, 57.8315679],
      "ул.Революционная": [58.317615, 57.8016969],
      "Революционная": [58.317615, 57.8016969]
    };
    ...
    const ROUTE_STOPS_LIST = {
      ...
      "7": ["пл.Металлургов", "пл.ЧМЗ", "Поликлиника", "ул.Революционная", "пл.Металлургов"],
    ...
    if (!hasTrack) {
      schemeActiveRouteInfo.innerHTML = `
        <div class="active-route-info-card" style="border-left: 3px solid #64748b; padding-left: 0.5rem;">
          ...
          <span>Траектория движения в процессе выравнивания. Доступны маршруты: №3, №5, №6, №7, №9, №10, №11.</span>
        </div>
      `;
      return;
    }
